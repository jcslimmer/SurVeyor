...
indel_t* remap_rc_cluster(consensus_t* consensus, IntervalTree<ext_read_t*>& candidate_reads_itree, std::string contig_name,
    ...
    indel_t* indel = remap_consensus(contig_name, consensus->sequence, contig_seq, contig_len, ref_start, ref_len, remap_target_start,
...
indel_t* remap_lc_cluster(consensus_t* consensus, IntervalTree<ext_read_t*>& candidate_reads_itree, std::string contig_name,
	...
	indel_t* indel = remap_consensus(contig_name, consensus->sequence, contig_seq, contig_len, remap_target_start, remap_target_len,
