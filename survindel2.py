...
import numpy as np
from survindel2_random_pos_generator import RandomPositionGenerator
...
read_categorizer_cmd = SURVINDEL_PATH + "/bin/survindel2_reads_categorizer %s %s %s" % (cmd_args.bam_file, cmd_args.workdir, cmd_args.reference)
...
clip_consensus_builder_cmd = SURVINDEL_PATH + "/bin/survindel2_clip_consensus_builder %s %s %s %s" % (cmd_args.bam_file, cmd_args.workdir, cmd_args.reference, sample_name)
print("Executing:", clip_consensus_builder_cmd)
os.system(clip_consensus_builder_cmd)

normalise_cmd = SURVINDEL_PATH + "/bin/survindel2_normalise %s/sr.vcf.gz %s/sr.norm.vcf.gz %s" % \
                (cmd_args.workdir, cmd_args.workdir, cmd_args.reference)
print("Executing:", normalise_cmd)
os.system(normalise_cmd)

merge_identical_calls_cmd = SURVINDEL_PATH + "/bin/survindel2_merge_identical_calls %s/sr.norm.vcf.gz %s/sr.norm.dedup.vcf.gz" % \
                (cmd_args.workdir, cmd_args.workdir)
print("Executing:", merge_identical_calls_cmd)
os.system(merge_identical_calls_cmd)

dp_clusterer = SURVINDEL_PATH + "/bin/survindel2_dp_clusterer %s %s %s %s" % (cmd_args.bam_file, cmd_args.workdir, cmd_args.reference, sample_name)
